...
$sql="select * from tbl_payment where booking_id='".$_POST['book_id']."'";
$rslt=mysqli_query($conn,$sql);
$row=mysqli_fetch_array($rslt);
//$total=$_SESSION['totamountservice']*10/100;
$pending=$row['totalamt']-$row['advamt'];
$_SESSION['pending']=1;
}
else{
  $_SESSION['pending']=0;
...
//   echo "jfdkvvvvvvvfffffff".$_SESSION['book_id'];
// $sqlpending="select * from packagebooking where pkgbook_id='".$_SESSION['book_id']."'";
...
<body>
  ...
  <div class="wrapper" id="app">
    <div class="card-form">
      ...
      <form action="savebookingpackagepending.php" method="post">
