  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
    <style>
        ...
        .popup-content {
            background-color: rgba(249, 249, 249, 0.273);
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <main class="main" id="main" style="background-image:url('img/car-wash-detailing-station.jpg');">
            ...
            <div class="align-items-center">
                <div class="form-wrapper">
                    ...
                    <form action="addpackage.php" method="post" enctype="multipart/form-data">
                        ...
                        ?>
                            <input type="checkbox" name="chktype[]" value="<?php echo $row['t_id']; ?>"><?php echo $row['name']; ?></input></br>
