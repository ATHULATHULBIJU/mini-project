            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="ml-auto">
                            <a class="btn btn-custom" href="signup.php">Booking</a>
                        </div>
                    </div>
                </nav>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/hatchback" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Hatchback</h2>
                                <p>5 seater</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/sedan.jpg" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>sedan</h2>
                                <p>5 seater</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/suv" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>suv</h2>
                                <p>7 seater</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/muv" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>muv</h2>
                                <p>7 seater</p>
