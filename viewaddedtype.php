...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    $id=$_POST['ids'];
    echo $id;
    $sql="DELETE FROM tbl_type WHERE t_id='".$id."'";
                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Product ID: <?php echo $row['t_id']; ?></p>
                            ...
                            <form method="POST" action="viewaddedtype.php">
                                <input type="hidden" name="ids" value="<?php echo $row['t_id']; ?>">
                                <input type="submit" name="id" value="Delete" class="btn btn-danger">
                                <button type="button" class="btn btn-danger" onclick="showUpdatePopup(<?php echo $row['t_id']; ?>, '<?php echo $row['name']; ?>','<?php echo $row['image']; ?>', '<?php echo $row['price']; ?>', '<?php echo $row['duration']; ?>'  )">Edit</button>
