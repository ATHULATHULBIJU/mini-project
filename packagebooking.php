...
<html lang="en">
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="ml-auto">
                            <a class="btn btn-custom" href="pricebooking.php">Booking</a>
                        </div>
                    </div>
                </nav>
            </div>
 ...
 $sql = "SELECT * FROM tbl_package where p_id='".$packageid."'";
...
?> </div>
                                ...
                                <div class="control-group"  id="amount">
                                  ...
                                  <div>
                                    ...
                                    <button class="btn btn-custom" type="submit" name="submit">Send Request</button>
                                </div>
                            </form>
                        </div>
                    </div>
