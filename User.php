    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <div class="team-img">
                        <img src="img/order" alt="Your Order Logo">
                    </div>
                    <div class="team-text"><a href="mybooking.php">
                        <h2>Your Booking</h2></a>
                        <p>View and manage your Booking.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <div class="team-img">
                        <img src="img/unknown.png" alt="Edit Profile Logo">
                    </div>
                    <div class="team-text">       
                      <a href="profile.php">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <div class="team-img">
                        <img src="img/contact.jpg.jpg" alt="Contact Us Logo">
                    </div>
                    <div class="team-text">
                      <a href="">
                   
                        <h2>Contact Us</h2>
                        <p>Get in touch with us for support.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <div class="team-img">
                        <img src="img/lock.jpg.jpg" alt="Password Change Logo">
                    </div>
                    <div class="team-text">
                      <a href="changepassword.php">
                        <h2>Password Change</h2>
                        <p>Change your account password.</p></a>
                    </div>
                </div>
            </div>
        </div>
