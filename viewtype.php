                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="viewaddedtype.php">
                                ...
                                <button type="button" class="btn btn-danger" onclick="showUpdatePopup(<?php echo $row['t_id']; ?>, '<?php echo $row['name']; ?>','<?php echo $row['price']; ?>', '<?php echo $row['duration']; ?>'  )">Edit</button>
