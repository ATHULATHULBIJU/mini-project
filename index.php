                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <?php if(isset($_SESSION['name'])){ ?>
                        <div class="nav-item dropdown" style="color:#fff;">
                            ...
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" style="color:#fff;">icon</a>
                            <div class="dropdown-menu">
                        ...
                        <?php }else{ ?>
                            <a href="signup.php" class="btn btn-custom">login/Sign UP</a>
                            <?php }?>
                        ...
                        <div class="col-md-6">
                            <div class="location-item">
                                ...
                                <div class="location-text">
                                    ...
                                    <p><strong>Call:</strong>36676372473</p>
                                </div>
                            </div>
                        </div>
                       < <div class="col-md-6">
                            <div class="location-item">
                                ...
                                <div class="location-text">
                                    <h3>Car Washing Point</h3>
                                    <p>piravom, kerala, india</p>
                                     <p><strong>Call:</strong>4556568989</p>
                                </div>
                            </div>
                        </div>
