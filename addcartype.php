...
$todir = 'image/';      
 ...
 $sql = "insert into tbl_car(type,addpay,image) values('$name','$price','$image')";
...
<?php
  ...
  <main class="main" style="background-image:url('img/car-wash-detailing-station.jpg');">
    ...
    <div class="align-items-center">
        ...
        <h2>New car Type</h2>
        <form action="#" method="post" enctype="multipart/form-data"style="width:500px;height:300px; padding:50px;">
        <label for="name">Select an image:</label>
        <input type="file" name="image"><br>
            <label for="name"> cartype name</label>
